...
public class PlayerControls : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (isRaw)
        {
            ...
            move = new Vector2(Input.GetAxisRaw("Horizontal") + joystick.Horizontal, Input.GetAxisRaw("Vertical") + joystick.Vertical).normalized;
        }
        else
        {
            move = new Vector2(Input.GetAxis("Horizontal") + joystick.Horizontal, Input.GetAxis("Vertical") + joystick.Horizontal).normalized;
        }
